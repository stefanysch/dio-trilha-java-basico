...
public class MediaDeNotas{
    ...
    public static void main(String[] args) {
        ...
        while (nota1 < 0 || nota1 > 10) {
            System.out.println("Informe a primeira nota (Deve estar no intervalo de 0 a 10): . Preste atenção!");
            nota1 = scanner.nextFloat();
        }
        ...
        while (nota2 < 0 || nota2 > 10) {
            System.out.println("Informe a segunda nota (Deve estar no intervalo de 0 a 10): . Preste atenção!");
            nota2 = scanner.nextFloat();
        }
        ...
        while (nota3 < 0 || nota3 > 10) {
            System.out.println("Informe a terceira nota (Deve estar no intervalo de 0 a 10): . Preste atenção!");
            nota3 = scanner.nextFloat();
        }
        ...
        while (nota4 < 0 || nota4 > 10) {
            System.out.println("Informe a quarta nota (Deve estar no intervalo de 0 a 10): . Preste atenção!");
            nota4 = scanner.nextFloat();
        }
